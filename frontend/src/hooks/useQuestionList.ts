...
export const useQuestionList = () => {
  ...
  const addQuestion = ({title, description, complexity, categories }: {title: string, description: string, complexity: QuestionComplexity, categories: string[]}) => {
  ...
  return {questions: questionListWrapper.questions, addQuestion, removeQuestion, editQuestion}
