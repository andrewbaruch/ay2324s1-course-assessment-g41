...
exports.processMatching = void 0;
...
const messageHandler = (message) => {
    ...
    if (parsedData.userId in matchingPairs)
        return;
    ...
    while (dequeuedPairs[complexity].length != 0) {
        console.log(`time ${(currentTime - dequeuedPairs[complexity][0].time) / 1000}`);
        if ((currentTime - dequeuedPairs[complexity][0].time) / 1000 <=
...
exports.processMatching = processMatching;
